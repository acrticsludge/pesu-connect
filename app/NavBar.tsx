...
export default function NavBar() {
  ...
  return (
    <motion.header
      ...
      initial="hidden"
      animate="visible"
      className="sticky top-0 z-50 w-full bg-black/30 backdrop-blur-xl shadow-[0_8px_24px_-10px_rgba(168,85,247,0.45)]"
    >
      ...
      <div className="relative mx-auto flex h-14 sm:h-16 max-w-6xl items-center justify-between px-3 sm:px-6">
        ...
        >
          {isLoading ? (
            <div className="w-16 sm:w-24 h-8 sm:h-10 bg-linear-to-r from-purple-600/30 via-purple-500/20 to-purple-600/30 rounded-full animate-shimmer" />
          ) : user ? (
